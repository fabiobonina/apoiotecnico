...
(0, 'Fabio Bonina', 'fabiobonina@gmail.com', 'fabio', '123abc', '3', '0', '2016-10-03', '2016-10-03 11:56:01');
...
ALTER TABLE `tb_ativo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tb_ativo_tb_oat1_idx` (`tb_oat_id`);
...
--
ALTER TABLE `tb_ativo`
  ADD CONSTRAINT `fk_tb_ativo_tb_oat1` FOREIGN KEY (`tb_oat_id`) REFERENCES `tb_oat` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
