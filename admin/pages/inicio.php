     ...
     <div class="row">
            ...
            <?php
               ...
               '<div class="alert alert-info">
                      ...
                      <strong>Olá, '.$nomeLogado.'!</strong> Seja Bem vindo ao <strong>SKYHUB System</strong> !
               </div>';
					}
				}
			 ?>  
            ...
            <div class="span12">	      		
	      		<div id="target-1" class="widget">	      			
	      			<div class="widget-content">	      				
			      		<h1>SKYHUB System- Apresentação</h1>			      		
			      		<p>O <strong>SKYHUB System</strong> é um Sistema de Postagem desenvolvido pelo canal '<strong>Web Vídeo Aulas</strong>', cujo objetivo é gerenciar toda parte de postagens e
