            ...
            <!-- Small modal -->
            <div class="modal fade modal-ativoEdt<?php echo $ativoId; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <form id="demo-form2" data-parsley-validate method="post" action="" class="form-horizontal form-label-left">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" name="ativoEdt" class="btn btn-success">Enviar Ativo</button>
                    </div>
                  </form>
                </div>
              </div>
