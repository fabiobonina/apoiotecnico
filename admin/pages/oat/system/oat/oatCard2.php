                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                          ...
                          <?php }else{       ?>
                          <li><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm<?php echo $oatId; ?>"><i class='fa  fa-sign-in'></i> OS</button></li>
                          <li><button type="button" class="btn btn-dark" data-toggle="modal" data-target=".modal-oatEdt<?php echo $oatId; ?>"><i class='fa  fa-edit'></i> ALT</a></button></li>
                          <li><?php echo "<a href='". $redirecionar_1 ."&acao1=deletar&oatId=" . $oatId . "' class='btn btn-danger' onclick='return confirm(\"Deseja realmente deletar?\")'><i class='fa  fa-trash-o'></i> DEL</a>"; ?></li>
                          <?php } ?>
                        </ul>
                      </div>
