          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              <?php
                ...
                if($acao=='add'){include("admin/pages/oat/system/servico/add.php");}	
                  // cadastro
                if($acao=='edt'){include("admin/pages/oat/system/servico/edt.php");}
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <?php echo "<a href='oat-system.php?acao=servicos&acao1=edt&id=" . $value->id . "'><i class='fa  fa-edit'></i>Editar </a>"; ?>
                            <?php echo "<a href='oat-system.php?acao=servicos&acao1=deletar&id=" . $value->id . "' onclick='return confirm(\"Deseja realmente deletar?\")'><i class='fa  fa-trash-o'></i>Deletar</a>"; ?>
                          </td>
                        </tr>
                      </tbody>
                      <?php endforeach; ?>
