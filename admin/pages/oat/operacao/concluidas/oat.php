          ...
          if(isset($_POST['ativAdd'])):
            if(!isset($_POST['cliente']) OR !isset($_POST['localidade']) OR !isset($_POST['plaqueta'])){
              ...
              if($ativos->insert()){
                ...
                header("Refresh: 1, oat-operacao.php?acao=concluidas&acao1=consulta&oat=". $oat );	
              }
            }
          endif;
          ...
          if(isset($_POST['descEdt'])):
            ...
            if(isset($_GET['acao2']) && $_GET['acao2'] == 'descDel'):
              ...
              if($oats->concluidas($id)){
                ...
                header("Refresh: 1, oat-operacao.php?acao=concluidas");	
              }
						endif;
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>OAT <small>Fechadas</small></h3>
              </div>
            ...
            <?php
              if(isset($_GET['acao1'])){
              $acao = $_GET['acao1'];	
              if($acao=='consulta'){include("admin/pages/oat/operacao/concluidas/consulta.php");}
              }else{
                  include("admin/pages/oat/operacao/concluidas/concluidas.php");
              }
            ?>
