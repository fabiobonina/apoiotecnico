                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Ação</th>
                			...
                			<?php foreach($oats->findAll() as $key => $value):if($value->ativo == 0 && $value->status == 1 && $value->nickuser == $userUsuario) {
                        $oatId = $value->id;
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <?php echo "<a href='oat-operacao.php?acao=retorno&acao1=consulta&oat=" . $oatId . "'><i class='fa  fa-edit'></i>Consulta</a>"; ?>
                          </td>
                        </tr>
                      </tbody>
                      <?php }endforeach; ?>
