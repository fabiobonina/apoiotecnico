                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate method="post" action="" class="form-horizontal form-label-left">
                      ...
                      <input type="text" name="cod" value="<?php echo $cod; ?>" class="form-control col-md-7 col-xs-12" >
                      <input type="text" name="oat" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12">
                      </div>
